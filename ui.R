fluidPage(
  ...
  column(11,
         "This webapp finds a statistical equivalent for any game score in other sports with a statistical rule, using data from NBA, NHL, NFL and Champions League games since the year 2000.", 
         "Equivalent scores are determined by how frequently they happen.",
